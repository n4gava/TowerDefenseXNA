...
{
    public class TexturaSpriteMovimentoAtaque : TexturaMovimento
    {
        ...
        public TexturaSpriteMovimentoAtaque Clone()
        {
            TexturaSpriteMovimentoAtaque textura = new TexturaSpriteMovimentoAtaque(this.textura, this.colunas, this.linhas);
            return textura;
        }
    }
}
